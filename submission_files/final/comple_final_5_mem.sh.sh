...
echo "pucker outputs/pdb_outputs/api_opt_all @2 @3 @4 @5 @1 range360 amplitude cremer out outputs/pdb_outputs/pucker_check.dat" >>\
 outputs/pdb_outputs/ptraj.in
echo "Ring Atoms: 5" >> outputs/all_energies.txt
