#!/bin/sh
source activate /opt/anaconda/4.10.1/envs/charmm_gpuenv
module load amber
api_${pucker}_opt.xyz
for parent in */; do
cd $parent
sugar="${parent::-1}"
rm -rf outputs
...
touch outputs/pdb_outputs/api_opt_all.pdb
touch outputs/pdb_outputs/ptraj.in
mkdir outputs/xyz_outputs
echo "trajin outputs/pdb_outputs/api_opt_all.pdb" > outputs/pdb_outputs/ptraj.in
echo "pucker outputs/pdb_outputs/api_opt_all @2 @3 @4 @5 @6 @1 range360 theta amplitude cremer out outputs/pdb_outputs/pucker_check.dat" >>\
...
cat ../outputs/pdb_outputs/${pucker}_opt.pdb >> ../outputs/pdb_outputs/api_opt_all.pdb
...
electronic_energy=$(echo "$electronic_ZPE - $ZPE_correction" | bc)
